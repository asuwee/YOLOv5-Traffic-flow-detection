...
class Colors:
    ...
    def __init__(self):
        ...
        hex = ('FF3838', '00C2FF', '344593', '6473FF', 'CFD231', '48F90A', '92CC17', '3DDB86', '1A9334', '00D4BB',
...
class Annotator:
    ...
    def line(self, xy, color=(128, 128, 128), thickness=1, lineType=None) -> None:
        r"""line(self, xy, color=(128, 128, 128), thickness=1, lineType=None) -> None
        @brief 划线
        @param xy [x, y, x, y] 线两端的坐标
    ...
    def lines(self, points, color=(128, 128, 128), thickness=1, lineType=None) -> None:
        r"""lines(self, points, color=(128, 128, 128), thickness=1, lineType=None) -> None
        @brief 划线
